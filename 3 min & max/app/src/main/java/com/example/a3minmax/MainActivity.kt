...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bt1.setOnClickListener()
        {
            ...
            Toast.makeText(this, "Minimum: $min1, $min2, $min3", Toast.LENGTH_SHORT).show()
        }
        ...
        bt2.setOnClickListener()
        {
            ...
            Toast.makeText(this, "Maximum: $max1, $max2, $max3", Toast.LENGTH_SHORT).show()
        }
    }
}